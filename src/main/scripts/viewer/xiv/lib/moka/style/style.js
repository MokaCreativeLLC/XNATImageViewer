 ...
 * @constructor
 */
goog.provide('moka.style');
moka.style = function () {};
goog.exportSymbol('moka.style', moka.style);
 ...
 * @public
 */
moka.style.removeClassesThatContain = function (elt, containsStr) {
 ...
 * @public
 */
moka.style.absolutePosition = function ( elt) {
 ...
 * @public
 */
moka.style.dims = function (elt, property) {
	...
	default:
	    ...
	    if (!val) {
		return moka.convert.toInt(elt.style[property]);
	    }
 ...
 * @public
 */
moka.style.getStyleSheet = function(unique_title){
 ...
 * @public
 */
moka.style.getComputedStyle = function (elt, opt_propertyKey) {
	...
	if (opt_propertyKey === undefined) {
	    opt_propertyKey = moka.style.cssProperties;
	}
	/**
	...
	return moka.style.parseIntNumericalProperties(attrs);
    }
 ...
 * @public
 */
moka.style.parseIntNumericalProperties = function (obj) {
 ...
 * @public
 */
moka.style.setStyle = function (elt, styleObj) {
	...
	if (styleObj[dim]) {
		...
		elt.style[dim] = moka.convert.px(styleObj[dim]);
	    }
	}
    })
}
 ...
 * @public
 */	
moka.style.setHoverClass = function(elt, className, opt_eventFindTuneMethod, 
 ...
 *    start end dims from.  Defaults to moka.style.cssProperties if 
 *    undefined.
 * @return {Object.<string.<Object.<string, string|number>>>}
 * @public
 */
moka.style.determineStartEndDimsCSS = function(elt, toBeClass, 
						opt_adjustcallback, 
						opt_properties) {
    ...
    //------------------
    var startDim = moka.style.getComputedStyle(elt, opt_properties);
    var endDim = moka.style.getComputedStyle(tempEndStateElt, opt_properties);
 ...
 * @public
 */
moka.style.getPositionRelativeToAncestor = function(element, ancestor) {
