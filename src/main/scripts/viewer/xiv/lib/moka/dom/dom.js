...
/**
 * 'moka.com' is a utility class that handles element and 
 * dom operations not provided by the JS platform or goog.dom.
 * @constructor
 */
goog.provide('moka.dom');
moka.dom = function () {};
goog.exportSymbol('moka.dom', moka.dom);
 ...
 * @public
 */
moka.dom.createBasicHoverButtonSet = function(idPrefixes, opt_iconSrcFolder, 
					       opt_iconExt){
	...
	key = idPrefixes[i];
	buttonSet[key] = moka.dom.createBasicHoverButton(key, {
 ...
 * @public
 */
moka.dom.createDivChildImage = function(div, src){
 ...
 * @public
 */
moka.dom.createBasicHoverButton = function(idPrefix, 
    ...
    moka.dom.createUniqueDom('div', idPrefix, attrs);
    //
    // Make an 'img' element if there's a 'src' attrib.
    //
    if (opt_attrs && opt_attrs['src']){
	moka.dom.createDivChildImage(buttonDiv, opt_attrs['src']);
    }
    //
    ...
    moka.fx.setBasicHoverStates(buttonDiv, 
 ...
 *      goog.string.toSelectorCase(moka.string.getLettersOnly(idPrefix))
 ...
 * @public
 */
moka.dom.createUniqueDom = function (type, idPrefix, opt_attrs) {
 ...
 * @public
 */
moka.dom.stopPropagation = function (e) {
 ...
 * @public
 */
moka.dom.checkForExtraneousArgs = function (templateArgs, args, opt_callback) {
    ...
    for (var attr in args) { 
    	if (! (attr in templateArgs)) {
   		...
   		moka.dom.validateArgs(originString, templateArgs[attr], 
				       args[attr])
   	    } 		
    	}
    }
 ...
 * @public 
 */ 
moka.dom.readCSS = function(cssClassName) {
