 ...
 * @constructor
 */
goog.provide('moka.array');
moka.array = function () {};
goog.exportSymbol('moka.array', moka.array);
 ...
 * var nautralSortedKeys = alphaSortedKeys.sort(moka.array.naturalCompare);
 ...
 * @public
 */
moka.array.naturalCompare = function (a, b) {
    function chunkify(t) {
