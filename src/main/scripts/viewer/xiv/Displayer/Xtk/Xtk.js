...
/**
 * xiv.Displayer.Xtk is a subclass of the 'xiv.Displayer' class and calls on 
 ...
 */
goog.provide('xiv.Displayer.Xtk');
xiv.Displayer.Xtk = function(ViewBox) {
    this.constructor.ID_PREFIX = xiv.Displayer.ID_PREFIX;
    goog.base(this);
...
goog.inherits(xiv.Displayer.Xtk, xiv.Displayer);
goog.exportSymbol('xiv.Displayer.Xtk', xiv.Displayer.Xtk);
 ...
 * @type {!string} 
 */
xiv.Displayer.Xtk.DEFAULT_LAYOUT = "Four-Up";
 ...
 * @private
 */
xiv.Displayer.Xtk.prototype.slicerSettings_;
 ...
 * @private
 */ 
xiv.Displayer.Xtk.prototype.currentViewables_;
 ...
 * @private
 */
xiv.Displayer.Xtk.prototype.currentViewablesSettings_;
 ...
 * @private
 */
xiv.Displayer.Xtk.prototype.currentSlicerSetting_;
 ...
 * @public
 */    
xiv.Displayer.Xtk.prototype.__defineGetter__('ViewPlanes', function() {
 ...
 * @public
 */    
xiv.Displayer.Xtk.prototype.__defineGetter__('Interactors', function() {
 ...
 * @public
 */ 
xiv.Displayer.Xtk.prototype.__defineSetter__('onPreload', function(callback){
...
* @public
*/
xiv.Displayer.Xtk.prototype.__defineSetter__('onLoaded', function (callback) {
 ...
 *     If none, defaults to 'xiv.Displayer.Xtk.DEFAULT_LAYOUT'.
 * @public
 */
xiv.Displayer.Xtk.prototype.getViewLayout =  function(){
	...
	return xiv.Displayer.Xtk.DEFAULT_LAYOUT;
    }
}
 ...
 * @public 
 */
xiv.Displayer.Xtk.prototype.__defineGetter__('BackgroundColors', function(){
 ...
 * @private
 */ 
xiv.Displayer.Xtk.prototype.syncControllerMenu_ = function(){
 ...
 * @public
 */
xiv.Displayer.Xtk.prototype.isLoaded = function(fileCollection) {
 ...
 */
xiv.Displayer.Xtk.prototype.makeXtkObject_ = function(fileOrFiles, opt_properties){
 ...
 * @inheritDoc
 */
xiv.Displayer.Xtk.prototype.load = function (xnatProperties) {


    xiv.Displayer.Xtk.superClass_.load.call(this, xnatProperties);
 ...
 * @private
 */
xiv.Displayer.Xtk.prototype.loadFiles_ = function (fileUris) {
 ...
 * @private
 */
xiv.Displayer.Xtk.prototype.storeViewables_ = function(viewableType, xtkObj, viewableSettings) {
 ...
 * @private
 */
xiv.Displayer.Xtk.prototype.determineSelectedVolume_ = function(){
 ...
 * @private
 */
xiv.Displayer.Xtk.prototype.getSlicerSettingsPerMrml_ = function(fileCollection, settings){
    var basename = '';
    var ext = '';
 ...
 * @private
 */
xiv.Displayer.Xtk.prototype.getSlicerSceneThumbnails_ = function(fileCollection, settings){
    var basename = '';
    var ext = '';
    var screenshotName = '';
 ...
 * @private
 */
xiv.Displayer.Xtk.prototype.updateUrls_ = function(settings){
    var viewableArr = [];
 ...
 * @public
*/
xiv.Displayer.Xtk.prototype.loopSettingsViewables = function(settings, callback){
 ...
 * @private
 */
xiv.Displayer.Xtk.prototype.loadSlicer_ = function (fileCollection) {
 ...
 * @private
 */
xiv.Displayer.Xtk.prototype.showSlicerViewMenu_ = function(){
 ...
 * @public
 */
xiv.Displayer.Xtk.prototype.updateStyle = function (opt_args) {
...
* @private
*/
xiv.Displayer.Xtk.prototype.set2DRenderObject_ = function(fileName) {
...
xiv.Displayer.Xtk.CSS_CLASS_PREFIX = /**@type {string} @const*/ goog.getCssName('xiv-displayer');
xiv.Displayer.Xtk.ELEMENT_CLASS = /**@type {string} @const*/ goog.getCssName(xiv.Displayer.Xtk.CSS_CLASS_PREFIX, '');
