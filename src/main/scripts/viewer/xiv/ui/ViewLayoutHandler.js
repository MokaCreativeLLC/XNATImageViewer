...
/**
 * xiv.ui.ViewLayoutHandler is the class that handles the various xiv.ui.ViewLayouts 
 ...
 * given xiv.ui.ViewBox.  The xiv.ui.ViewLayoutHandler keeps track of the xiv.ui.ViewLayouts
 ...
 * @constructor
 */
goog.provide('xiv.ui.ViewLayoutHandler');
xiv.ui.ViewLayoutHandler = function() {
...
goog.exportSymbol('xiv.ui.ViewLayoutHandler', xiv.ui.ViewLayoutHandler);
...
*/ 
xiv.ui.ViewLayoutHandler.prototype.viewLayouts_ = null;  
...
* @type {boolean}
*/ 
xiv.ui.ViewLayoutHandler.prototype.animateViewLayoutChange_ = true;
...
* @type {!Array.<Element>}
*/ 
xiv.ui.ViewLayoutHandler.prototype.visiblePlanes_ = null;
...
* @type {!Array.<Element>}
*/ 
xiv.ui.ViewLayoutHandler.prototype.visibleInteractors_ = null;
...
* @param {boolean}
*/ 
xiv.ui.ViewLayoutHandler.prototype.animateViewLayoutChange = function(bool){
...
*/ 
xiv.ui.ViewLayoutHandler.prototype.getViewLayouts = function(){
...
*/ 
xiv.ui.ViewLayoutHandler.prototype.currViewLayout_ = null;
...
*/ 
xiv.ui.ViewLayoutHandler.prototype.getCurrViewLayout = function(){
 ...
 * @type {?Element}
 */    
xiv.ui.ViewLayoutHandler.prototype.planeX_ = null;
 ...
 * @type {?Element}
 */   
xiv.ui.ViewLayoutHandler.prototype.planeY_ = null;
 ...
 * @type {?Element}
 */   
xiv.ui.ViewLayoutHandler.prototype.planeZ_ = null;
 ...
 * @type {?Element}
 */   
xiv.ui.ViewLayoutHandler.prototype.planeV_ = null;
 ...
 * @type {?Array}
 */   
xiv.ui.ViewLayoutHandler.prototype.planesAll_ = null;
 ...
 * @type {?Array}
 */   
xiv.ui.ViewLayoutHandler.prototype.planes2D_ = null;
...
* @type {?Object}
*/ 
xiv.ui.ViewLayoutHandler.prototype.viewPlaneInteractors_ = null;
...
* @type {?Array.function}
*/ 
xiv.ui.ViewLayoutHandler.prototype.onMultipleViewPlanesVisibleCallbacks_ = null;
...
* @type {?Array.function}
*/ 
xiv.ui.ViewLayoutHandler.prototype.onOneViewPlaneVisibleCallbacks_ = null;
...
* @type {?Array.function}
*/ 
xiv.ui.ViewLayoutHandler.prototype.onViewLayoutSetCallbacks_ = null;
...
* @type {?Array.function}
*/ 
xiv.ui.ViewLayoutHandler.prototype.onViewLayoutAnimateCallbacks_ = null;
 ...
 * @type {?Array.function}
 */ 
xiv.ui.ViewLayoutHandler.prototype.planeDoubleClickedCallback_ = null;
 ...
 * @param {function}
 */ 
xiv.ui.ViewLayoutHandler.prototype.onPlaneDoubleClicked = function(callback){
 ...
 * @type {?xiv.ui.ViewLayout}
 */ 
xiv.ui.ViewLayoutHandler.prototype._defaultMultiView = null;
 ...
 * @type {?xiv.ui.ViewLayout}
 */ 
xiv.ui.ViewLayoutHandler.prototype._defaultSingleView = null;
 ...
 */
xiv.ui.ViewLayoutHandler.prototype.setViewPlanes = function(viewPlaneElts, opt_viewPlaneInteractors) {
 ...
 * @param {!function}
 */ 
xiv.ui.ViewLayoutHandler.prototype.onMultipleViewPlanesVisible = function(callback) {
 ...
 * @param {!function}
 */ 
xiv.ui.ViewLayoutHandler.prototype.onOneViewPlaneVisible = function(callback) {
 ...
 * @param {!function}
 */ 
xiv.ui.ViewLayoutHandler.prototype.onViewLayoutChanged = function(callback) {
 ...
 * @param {!function}
 */ 
xiv.ui.ViewLayoutHandler.prototype.onViewLayoutAnimate = function(callback) {
...
*/
xiv.ui.ViewLayoutHandler.prototype.loop2D = function(callback) {
...
* @type {function(function)}
*/
xiv.ui.ViewLayoutHandler.prototype.loopAll = function(callback) {
    var that = this;
    if (this.planesAll_) {
 ...
 * @param {}
 */
xiv.ui.ViewLayoutHandler.prototype.implementViewLayout = function() {
 ...
 */ 
xiv.ui.ViewLayoutHandler.prototype.setViewLayout = function(viewLayout, callback) {
	...
	this.loopAll(function(viewPlaneElement, i, plane, interactor) {
		...
		var tempInteractorDims = moka.style.determineStartEndDimsCSS(interactor, this.currViewLayout_.cssSheetsInteractor[plane], function(asIsInteractor, toBeInteractor){
		    ...
		    // it's too specific for the xiv.ui.ViewLayoutHandler.
		    //
 ...
 * @private
 */
xiv.ui.ViewLayoutHandler.prototype.backgroundColor3d_ = ['rgba(0,0,0,0)', 'rgba(0,0,0,0)'];


/**
 * @param {!Array.<stringr>} colors
 */
xiv.ui.ViewLayoutHandler.prototype.set3DBackgroundColor = function(colors){
 ...
 * 
 */
xiv.ui.ViewLayoutHandler.prototype.applyBackground_ = function(){
 ...
 * @param {function}
 */
xiv.ui.ViewLayoutHandler.prototype.setPlanesDoubleClicked = function(callback){
