...
goog.inherits(xiv.ui.XtkController, moka.ui.Component);
 ...
 * @private
 */
xiv.ui.prototype.XtkController.label_ = null;
 ...
 * @public
 */
xiv.ui.prototype.XtkController.setLabel = function(labelTitle) {
 ...
 * @public
 */
xiv.ui.prototype.XtkController.disposeInternal = function() {
 ...
 * @type {!Array.<string>}
 */
xiv.ui.XtkController.rowSpacing = ['0%','27%','35%', '55%', '88%'];
 ...
 * @const
*/
xiv.ui.XtkController.CSS_CLASS_PREFIX =
goog.string.toSelectorCase(
    xiv.ui.XtkController.ID_PREFIX.toLowerCase().replace(/\./g,'-'));
 ...
 * @const
 */
xiv.ui.XtkController.ELEMENT_CLASS =  
    goog.getCssName(xiv.ui.XtkController.CSS_CLASS_PREFIX, '');
 ...
 * @const
 */
xiv.ui.XtkController.BUTTON_CLASS = 
    goog.getCssName(xiv.ui.XtkController.CSS_CLASS_PREFIX, 'button');
 ...
 * @const
 */
xiv.ui.XtkController.RADIO_BUTTON_CLASS = 
    goog.getCssName(xiv.ui.XtkController.CSS_CLASS_PREFIX, 'button-radio');
 ...
 * @const
 */
xiv.ui.XtkController.LABEL_BUTTON_CLASS = 
    goog.getCssName(xiv.ui.XtkController.CSS_CLASS_PREFIX, 'label-button');
 ...
 * @const
 */
xiv.ui.XtkController.ROW_CLASS = 
    goog.getCssName(xiv.ui.XtkController.CSS_CLASS_PREFIX, 'row');
 ...
 * @const
 */
xiv.ui.XtkController.LABEL_CLASS = 
    goog.getCssName(xiv.ui.XtkController.CSS_CLASS_PREFIX, 'label');
 ...
 * @const
 */
xiv.ui.XtkController.VALUE_CLASS = 
    goog.getCssName(xiv.ui.XtkController.CSS_CLASS_PREFIX, 'value');
 ...
 * @const
 */
xiv.ui.XtkController.SLIDER_CLASS = 
    goog.getCssName(xiv.ui.XtkController.CSS_CLASS_PREFIX, 'slider');
 ...
 * @const
 */
xiv.ui.XtkController.SLIDER_WIDGET_CLASS = 
    goog.getCssName(xiv.ui.XtkController.SLIDER_CLASS, 'widget');
 ...
 * @const
 */
xiv.ui.XtkController.SLIDER_THUMB_CLASS = 
    goog.getCssName(xiv.ui.XtkController.SLIDER_CLASS, 'thumb');
 ...
 * @const
 */
xiv.ui.XtkController.SLIDER_TRACK_CLASS = 
    goog.getCssName(xiv.ui.XtkController.SLIDER_CLASS, 'track');
 ...
 * @const
 */
xiv.ui.XtkController.TWOTHUMBSLIDER_CLASS = 
   goog.getCssName(xiv.ui.XtkController.CSS_CLASS_PREFIX, 'twothumbslider');
 ...
 * @const
 */
xiv.ui.XtkController.TWOTHUMBSLIDER_WIDGET_CLASS = 
    goog.getCssName(xiv.ui.XtkController.TWOTHUMBSLIDER_CLASS, 'widget');
 ...
 * @const
 */
xiv.ui.XtkController.TWOTHUMBSLIDER_THUMB_CLASS = 
    goog.getCssName(xiv.ui.XtkController.TWOTHUMBSLIDER_CLASS, 'thumb');
 ...
 * @const
 */
xiv.ui.XtkController.TWOTHUMBSLIDER_TRACK_CLASS = 
    goog.getCssName(xiv.ui.XtkController.TWOTHUMBSLIDER_CLASS, 'track');
 ...
 * @const
 */
xiv.ui.XtkController.THUMB_HOVER_CLASS = 
    goog.getCssName(xiv.ui.XtkController.CSS_CLASS_PREFIX, 'thumb-hover');
 ...
 * @private
 */
xiv.ui.XtkController.createVisible_ = 
 ...
 * @private
 */
xiv.ui.XtkController.createThreshold_ = function(fileName){
 ...
 * @private
 */
xiv.ui.XtkController.createVolumeRendering_ = function(fileName){
    var callback = function(button){
 ...
 * @private
 */
xiv.ui.XtkController.createToggleButton2D_ = 
function(fileName, category){
	...
	goog.array.forEach(goog.dom.getElementsByClass(
	    xiv.ui.XtkController.RADIO_BUTTON_CLASS), function(otherButton){
 ...
 * @private
 */
xiv.ui.XtkController.createDisplayAllController_ = function(){
    ...
    return xiv.ui.XtkController.createButtonRow(
 ...
 * @private
 */
xiv.ui.XtkController.createMasterOpacityRow_ = function(){
 ...
 * @private
 */
xiv.ui.XtkController.createOpacity_ = 
 ...
 * @return {Element}
 */
xiv.ui.XtkController.createRow = function (eltArr, opt_lefts) {
    var row = goog.dom.createDom('div', {
	'id' : 'ElementRow_' + goog.string.createUniqueString(),
	'class': xiv.ui.XtkController.ROW_CLASS
    });
 ...
 * @return {ArrayElement}
 */
xiv.ui.XtkController.createGenericControls_3D = 
function(xtkObject){
 
    var fileName = '';
    var displayAll = xiv.ui.XtkController.createDisplayAllController_();
    //var masterOpacity = xiv.ui.XtkController.createMasterOpacityRow_();
	...
	this.createRow([displayAll['label'], 
		      ...
		      masterOpacity['value']], 
		     xiv.ui.XtkController.rowSpacing), [folderName3D]);
	...
	this.menu3D_.addContents(  
	    this.createRow([visible['label'], visible['button'], 
			  ...
			  opacity['value']], 
			  xiv.ui.XtkController.rowSpacing),
 ...
 * @param {X.Object}
 */ 
xiv.ui.XtkController.createControllers_Volume = function(xtkObject){
    ...
    // controllers.
    //------------------
    var gen = xiv.ui.XtkController.createGenericControls_3D(xtkObject);
 ...
 */ 
xiv.ui.XtkController.addMeshes = function(xtkObjects){
 ...
 * @param {Array.<X.Object>}
 */ 
xiv.ui.XtkController.addDicoms = function(xtkObjects){
 ...
 * @param {Array.<X.Object>}
 */ 
xiv.ui.XtkController.addAnnotations = function(xtkObjects){
 ...
 * @param {Array.<X.object>}
 */
xiv.ui.XtkController.addFiber = function(xtkObjects){
 ...
 * @return {Element}
 */
xiv.ui.XtkController.getParent = function(elt){
 ...
 * @return {Element}
 */
xiv.ui.XtkController.createNumberDisplay = function(opt_parent){
    var value = goog.dom.createDom('div', {
	'id' : 'NumberDisplay_' + goog.string.createUniqueString(),
	'class': xiv.ui.XtkController.VALUE_CLASS
    });
 ...
 * @return {Element}
 */
xiv.ui.XtkController.createSliderRow = function(labelTitle, callback, fileAttr, opt_args) {
 ...
 * @return {Element}
 */
xiv.ui.XtkController.createButtonRow = 
function(labelTitle, callback, fileAttr, opt_args){
	...
	xiv.ui.XtkController.createRadioButton(document.body) : 
	xiv.ui.XtkController.createCheckBox(document.body);
    ...
    var controller = new xiv.ui.XtkController();
    controller.setTitle(labelTitle);
    controller.setComponent(button);s
 ...
 * @return {Object}
 */
xiv.ui.XtkController.createSlider = function(opt_parent, opt_args) {
    var slider;
    ...
    goog.dom.classes.add(slider.getTrack(),
			 xiv.ui.XtkController.SLIDER_TRACK_CLASS);
    slider.setHoverClasses(xiv.ui.XtkController.THUMB_HOVER_CLASS);
 ...
 * @return {Element}
 */
xiv.ui.XtkController.createTwoThumbSlider = function(opt_parent, opt_args) {
	...
	'class' : xiv.ui.XtkController.TWOTHUMBSLIDER_TRACK_CLASS
    });    
    ...
    //------------------    
    goog.dom.classes.add(elt, xiv.ui.XtkController.TWOTHUMBSLIDER_WIDGET_CLASS);
 ...
 * @return {!Element}
 */
xiv.ui.XtkController.createCheckBox = function(opt_parent){
    return goog.dom.createDom('input', { 
	'id': 'CheckBox_'+ goog.string.createUniqueString(),
	'class': xiv.ui.XtkController.BUTTON_CLASS + ',' + 
	    xiv.ui.XtkController.CHECKBOX_CLASS
    });  
}
 ...
 * @return {!Element}
 */
xiv.ui.XtkController.createRadioButton = function() {
    return goog.dom.createDom('input', {
	'id': xiv.ui.XtkController.BUTTON_CLASS + 
	    goog.string.createUniqueString(),
	'class': xiv.ui.XtkController.BUTTON_CLASS + ' ' 
	    + xiv.ui.XtkController.RADIO_BUTTON_CLASS
    });
