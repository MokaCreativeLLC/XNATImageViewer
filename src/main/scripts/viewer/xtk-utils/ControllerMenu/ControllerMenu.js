 ...
 */
goog.require('xtkUtils');




/**
 * xtkUtils.ControllerMenu defines the controllers
 ...
 */
goog.provide('xtkUtils.ControllerMenu');
xtkUtils.ControllerMenu = function(xtkDisplayer) {
    this.XtkDisplayer_ = xtkDisplayer;
    this.menu2D_ = {};
    this.menu3D_ = {};
}
goog.exportSymbol('xtkUtils.ControllerMenu', xtkUtils.ControllerMenu);




xtkUtils.ControllerMenu.CSS_CLASS_PREFIX = /**@type {string} @const*/ goog.getCssName('xtkutils-controllermenu');
xtkUtils.ControllerMenu.ELEMENT_CLASS = /**@type {string} @const*/ goog.getCssName(xtkUtils.ControllerMenu.CSS_CLASS_PREFIX, '');
xtkUtils.ControllerMenu.BUTTON_CLASS = /** @const @type {String} */ goog.getCssName(xtkUtils.ControllerMenu.CSS_CLASS_PREFIX, 'button');
xtkUtils.ControllerMenu.RADIO_BUTTON_CLASS = /** @const @type {String} */ goog.getCssName(xtkUtils.ControllerMenu.CSS_CLASS_PREFIX, 'button-radio');
xtkUtils.ControllerMenu.LABEL_BUTTON_CLASS = /** @const @type {String} */ goog.getCssName(xtkUtils.ControllerMenu.CSS_CLASS_PREFIX, 'label-button');
xtkUtils.ControllerMenu.ROW_CLASS = /** @const @type {String} */ goog.getCssName(xtkUtils.ControllerMenu.CSS_CLASS_PREFIX, 'row');
xtkUtils.ControllerMenu.LABEL_CLASS = /** @const @type {String} */ goog.getCssName(xtkUtils.ControllerMenu.CSS_CLASS_PREFIX, 'label');
xtkUtils.ControllerMenu.VALUE_CLASS = /** @const @type {String} */ goog.getCssName(xtkUtils.ControllerMenu.CSS_CLASS_PREFIX, 'value');
xtkUtils.ControllerMenu.SLIDER_CLASS = /** @const @type {String} */ goog.getCssName(xtkUtils.ControllerMenu.CSS_CLASS_PREFIX, 'slider');
xtkUtils.ControllerMenu.SLIDER_WIDGET_CLASS = /** @const @type {String} */ goog.getCssName(xtkUtils.ControllerMenu.SLIDER_CLASS, 'widget');
xtkUtils.ControllerMenu.SLIDER_THUMB_CLASS = /** @const @type {String} */ goog.getCssName(xtkUtils.ControllerMenu.SLIDER_CLASS, 'thumb');
xtkUtils.ControllerMenu.SLIDER_TRACK_CLASS = /** @const @type {String} */ goog.getCssName(xtkUtils.ControllerMenu.SLIDER_CLASS, 'track');
xtkUtils.ControllerMenu.TWOTHUMBSLIDER_CLASS = /** @const @type {String} */ goog.getCssName(xtkUtils.ControllerMenu.CSS_CLASS_PREFIX, 'twothumbslider');
xtkUtils.ControllerMenu.TWOTHUMBSLIDER_WIDGET_CLASS = /** @const @type {String} */ goog.getCssName(xtkUtils.ControllerMenu.TWOTHUMBSLIDER_CLASS, 'widget');
xtkUtils.ControllerMenu.TWOTHUMBSLIDER_THUMB_CLASS = /** @const @type {String} */ goog.getCssName(xtkUtils.ControllerMenu.TWOTHUMBSLIDER_CLASS, 'thumb');
xtkUtils.ControllerMenu.TWOTHUMBSLIDER_TRACK_CLASS = /** @const @type {String} */ goog.getCssName(xtkUtils.ControllerMenu.TWOTHUMBSLIDER_CLASS, 'track');
xtkUtils.ControllerMenu.THUMB_HOVER_CLASS = /** @const @type {String} */ goog.getCssName(xtkUtils.ControllerMenu.CSS_CLASS_PREFIX, 'thumb-hover');
 ...
 * @type {Array.<string>}
 */
xtkUtils.ControllerMenu.prototype.visibilityRowSpacing = ['0%','27%','35%', '55%', '88%'];
 ...
 * @type {Object}
 */ 
xtkUtils.ControllerMenu.prototype.XtkDisplayer_ = undefined;
 ...
 * @type {Object}
 */ 
xtkUtils.ControllerMenu.prototype.menu2D_ = {};
 ...
 * @return {Object}
 */ 
xtkUtils.ControllerMenu.prototype.getMenu2D = function(){
    return this.menu2D_;
};
 ...
 * @type {Object}
 */ 
xtkUtils.ControllerMenu.prototype.menu3D_ = {};
 ...
 * @return {Object}
 */ 
xtkUtils.ControllerMenu.prototype.getMenu3D = function(){
    return this.menu3D_;
};
 ...
 * @type {Object}
 */ 
xtkUtils.ControllerMenu.prototype.menuMap_ = {};
 ...
 * @return {Object}
 */ 
xtkUtils.ControllerMenu.prototype.getMenuMap = function(){
 ...
 */
xtkUtils.ControllerMenu.prototype.getMenu = function(){
    return {
 ...
 */
xtkUtils.ControllerMenu.prototype.makeControllerMenu = function(viewables) {
    var that = this;    
 ...
 */
xtkUtils.ControllerMenu.prototype.insertInMenu = function(menuObject, folderArr, elts) {
 ...
 * @private
 */
xtkUtils.ControllerMenu.prototype.makeVisible_ = function(fileName, opt_parentbutton){
    var that = this;
 ...
 * @private
 */
xtkUtils.ControllerMenu.prototype.makeThreshold_ = function(fileName){
    var that = this;
 ...
 * @private
 */
xtkUtils.ControllerMenu.prototype.makeVolumeRendering_ = function(fileName){
    var that = this;
    var callback = function(button){
 ...
 * @private
 */
xtkUtils.ControllerMenu.prototype.makeToggleButton2D_ = function(fileName, category){
    var that = this;
	...
	//
	goog.array.forEach(goog.dom.getElementsByClass(xtkUtils.ControllerMenu.RADIO_BUTTON_CLASS), function(otherButton){
 ...
 * @private
 */
xtkUtils.ControllerMenu.prototype.makeDisplayAll_ = function(){
 ...
 * @private
 */
xtkUtils.ControllerMenu.prototype.makeMasterOpacity_ = function(){
 ...
 * @private
 */
xtkUtils.ControllerMenu.prototype.makeOpacity_ = function(fileName, opt_parentslider){
    var that = this;
 ...
 * @return {Element}
 */
xtkUtils.ControllerMenu.prototype.makeRow = function (eltArr, opt_lefts) {
    var row = utils.dom.makeElement('div', document.body, 'ElementRow');
    goog.dom.classes.add(row, xtkUtils.ControllerMenu.ROW_CLASS);
 ...
 * @return {Element}
 */
xtkUtils.ControllerMenu.prototype.makeStandardVisibilityControls3D = function(folderName3D, xtkObjects){
    var that = this;
    var fileName = '';
 ...
 */ 
xtkUtils.ControllerMenu.prototype.addVolumes = function(xtkObjects){
    var that = this;
    var fileName = '';
 ...
 * @param {Array.<X.Object>}
 */ 
xtkUtils.ControllerMenu.prototype.addMeshes = function(xtkObjects){
    var that = this;
 ...
 * @param {Array.<X.Object>}
 */ 
xtkUtils.ControllerMenu.prototype.addDicoms = function(xtkObjects){
    var that = this;
 ...
 * @param {Array.<X.Object>}
 */ 
xtkUtils.ControllerMenu.prototype.addAnnotations = function(xtkObjects){
    var that = this;
 ...
 * @param {Array.<X.object>}
 */
xtkUtils.ControllerMenu.prototype.addFiber = function(xtkObjects){
    var that = this;
    var fileName = '';
 ...
 * @return {Element}
 */
xtkUtils.ControllerMenu.prototype.getParent = function(elt){
 ...
 * @return {Element}
 */
xtkUtils.ControllerMenu.prototype.makeLabel = function(labelTitle, opt_parent){
    var label = utils.dom.makeElement('div', this.getParent(opt_parent), 'Label' + goog.string.removeAll(labelTitle, ' '), {});
    goog.dom.classes.add(label, xtkUtils.ControllerMenu.LABEL_CLASS)
 ...
 * @return {Element}
 */
xtkUtils.ControllerMenu.prototype.makeNumberDisplay = function(opt_parent){
    var value = utils.dom.makeElement('div', this.getParent(opt_parent), 'NumberDisplay', {});
    goog.dom.classes.add(value, xtkUtils.ControllerMenu.VALUE_CLASS)
    return value;
}
 ...
 * @return {Element}
 */
xtkUtils.ControllerMenu.prototype.makeSliderRow = function(labelTitle, callback, fileAttr, opt_args) {
 ...
 * @return {Element}
 */
xtkUtils.ControllerMenu.prototype.makeButtonRow = function(labelTitle, callback, fileAttr, opt_args){
    var button, label
    ...
    //------------------
    label = this.makeLabel(labelTitle, document.body);
    goog.dom.classes.add(label, xtkUtils.ControllerMenu.LABEL_BUTTON_CLASS);
 ...
 * @return {Object}
 */
xtkUtils.ControllerMenu.prototype.makeSlider = function(opt_parent, opt_args) {
    var slider;
    ...
    // Make slider.
    //------------------
    slider = new utils.gui.GenericSlider({'parent': this.getParent(opt_parent)});
    ...
    // Set slider classes.
    //------------------
    slider.addClassToWidget(xtkUtils.ControllerMenu.SLIDER_WIDGET_CLASS);
    slider.addClassToThumb (xtkUtils.ControllerMenu.SLIDER_THUMB_CLASS);
    slider.addClassToTrack (xtkUtils.ControllerMenu.SLIDER_TRACK_CLASS);
    slider.setHoverClass(xtkUtils.ControllerMenu.THUMB_HOVER_CLASS);
 ...
 * sibling class of utils.gui.GenericSlider.
 *
 * @param {Element=, Object=}
 * @return {Element}
 */
xtkUtils.ControllerMenu.prototype.makeTwoThumbSlider = function(opt_parent, opt_args) {
    var that = this;
    ...
    goog.dom.classes.add(track, xtkUtils.ControllerMenu.TWOTHUMBSLIDER_TRACK_CLASS);
    ...
    //------------------    
    goog.dom.classes.add(elt, xtkUtils.ControllerMenu.TWOTHUMBSLIDER_WIDGET_CLASS);
	...
	if (child.className === 'goog-twothumbslider-value-thumb' || child.className === 'goog-twothumbslider-extent-thumb') {
	    goog.dom.classes.add(child, xtkUtils.ControllerMenu.TWOTHUMBSLIDER_THUMB_CLASS);
	    utils.style.setHoverClass(child,  xtkUtils.ControllerMenu.THUMB_HOVER_CLASS, function(applyHover, removeHover){

		//
		// set Dragging class
		//
		utils.gui.GenericSlider.superClass_.addEventListener.call(slider, goog.ui.SliderBase.EventType.DRAG_START, function (e) {

		    //
		    // Suspend mouseout listener when dragging.
		    //
		    goog.events.unlisten(child, goog.events.EventType.MOUSEOUT, removeHover);
		    goog.dom.classes.add(child, xtkUtils.ControllerMenu.THUMB_HOVER_CLASS);
		});	  
		utils.gui.GenericSlider.superClass_.addEventListener.call(slider, goog.ui.SliderBase.EventType.DRAG_END, function (e) {

		    //
		    // Reapply mouseout listener when done dragging.
		    //
		    goog.events.listen(child, goog.events.EventType.MOUSEOUT, removeHover);
		    goog.dom.classes.remove(child, xtkUtils.ControllerMenu.THUMB_HOVER_CLASS);
		});
	    });
	}		
    })
 ...
 * @return {Element}
 */
xtkUtils.ControllerMenu.prototype.makeCheckbox = function(opt_parent){

    var checkbox = utils.dom.makeElement('input', this.getParent(opt_parent), 'CheckBox', {});
    checkbox.type = 'checkbox';
    goog.dom.classes.add(checkbox, xtkUtils.ControllerMenu.BUTTON_CLASS );
    return checkbox;
}
 ...
 * @return {Element}
 */
xtkUtils.ControllerMenu.prototype.makeRadioButton = function(opt_parent){

    var radio = utils.dom.makeElement('input', this.getParent(opt_parent), 'Button', {});
    radio.type = 'radio';
    goog.dom.classes.add(radio, xtkUtils.ControllerMenu.BUTTON_CLASS);   
    goog.dom.classes.add(radio, xtkUtils.ControllerMenu.RADIO_BUTTON_CLASS);   
    return radio;
}
