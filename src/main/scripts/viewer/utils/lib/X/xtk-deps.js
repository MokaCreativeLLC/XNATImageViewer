...
goog.addDependency('../../../utils/lib/X/io/parser.js', ['X.parser'], ['X.base', 'X.event', 'X.texture', 'X.triplets']);
...
goog.addDependency('../../../utils/lib/X/io/parserNII.js', ['X.parserNII'], ['X.event', 'X.object', 'X.parser', 'X.triplets', 'Zlib.Gunzip', 'goog.math.Vec3', 'goog.vec.Mat4', 'goog.vec.Vec4']);
goog.addDependency('../../../utils/lib/X/io/parserNRRD.js', ['X.parserNRRD'], ['X.event', 'X.object', 'X.parser', 'X.triplets', 'Zlib.Gunzip', 'goog.math.Vec3']);
...
goog.addDependency('../../../utils/lib/X/objects/volume.js', ['X.volume'], ['X.object', 'X.slice', 'X.thresholdable']);
...
goog.addDependency('../../../utils/lib/X/visualization/renderer2D.js', ['X.renderer2D'], ['X.renderer', 'goog.math.Vec3']);
