...
utils.ui.ScrollableContainer = function (opt_args) {
    ...
    this._Slider = new utils.ui.GenericSlider({ 'parent': this._element, 'orientation' : 'vertical'});
    ...
    //------------------
    goog.dom.classes.set(this._element, utils.ui.ScrollableContainer.ELEMENT_CLASS);
    ...
    this._Slider.addClassToWidget(utils.ui.ScrollableContainer.SLIDER_ELEMENT_CLASS);
 ...
 * @type {?Element}
 */	    
utils.ui.ScrollableContainer.prototype._element = null;
