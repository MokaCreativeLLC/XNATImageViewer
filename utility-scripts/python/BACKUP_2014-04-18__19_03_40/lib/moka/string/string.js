 ...
 * @constructor
 */
goog.provide('moka.string');
moka.string = function () {};
goog.exportSymbol('moka.string', moka.string);
 ...
 * moka.string.basename('/foo/data/foofile.txt')
 * >> 'foofile.txt'
 * @param {!string} uri The uri to derive from.
 * @return {string} 
 * @public
 */
moka.string.basename = function (uri) {
 ...
 * @public
 */
moka.string.dirname = function (uri) {
 ...
 * @public
 */
moka.string.getFileExtension = function(file) {
 ...
 * via the 'moka.path.basename' method.
 * @param {!string} file1 Filename 1.
 * @param {!string} file2 Filename 2.
 * @return {boolean} Whether there's equality.
 * @public
 */
moka.string.fileNameMatch = function(file1, file2) {
    return moka.string.basename(file1) === moka.string.basename(file2);
}
 ...
 * @public
 */
moka.string.stripNonAlphanumeric = function(str) {
 ...
 * @public
 */
moka.string.stripIllegal = function(str) {
 ...
 * @public
 */
moka.string.getLettersOnly = function(str) {
    return moka.string.stripNonAlphanumeric(str).replace(/[0-9]/g, '');
}
 ...
 * @public 
 */
moka.string.replaceIllegal = function (value, opt_replaceStr) {
	
    if (typeof value !== 'string') {
	throw Error("Illegal value " + typeof value + 
		    " in argument of moka.string.replaceIllegal .")
    }
 ...
 * @public
 */
moka.string.truncateString = function(str, opt_maxLen){
