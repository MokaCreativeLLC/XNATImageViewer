 ...
 * @constructor
 */
goog.provide('moka.convert');
moka.convert = function () {};
goog.exportSymbol('moka.convert', moka.convert);
 ...
 * @public 
 */
moka.convert.pct = function (value) {
 ...
 * @public 
 */
moka.convert.remap1D = function (startVal, prevRange, newRange) {
 ...
 * @public 
 */
moka.convert.toInt = function (val) {
 ...
 * @public 
 */
moka.convert.toFloatArray = function (val) {
 ...
 * @public 
 */
moka.convert.objectToArray = function (val) {
 ...
 * @public 
 */
moka.convert.rgbToArray = function (val) {
    if ((!goog.isString(val))){
	throw new TypeError('String expected!', val);
    }
 ...
 * @public 
 */
moka.convert.arrayToRgb = function (val, opt_multiplier) {
    if ((!goog.isArray(val))){
